module.exports = function( grunt ) {
  ...
  grunt.initConfig( {
    ...
    copy: {
      main: {
        src: [
          ...
          'templates/**',
          'index.php',
          'woocommerce-installment-emails.php',
          'readme.txt',
          'CHANGELOG.md',
          'LICENSE',
    ...
    addtextdomain: {
      options: {
        textdomain: 'woocommerce-installment-emails',
      },
      update_all_domains: {
        options: {
          updateDomains: true
    ...
    makepot: {
      target: {
        options: {
          ...
          mainFile: 'woocommerce-installment-emails.php',
          potFilename: 'woocommerce-installment-emails.pot',
          potHeaders: {
            poedit: true,
